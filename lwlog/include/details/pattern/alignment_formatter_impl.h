...
namespace lwlog::details
{
                                                   ...
                                                   char* padding_buffer, const alignment_info& alignment_flag_info)
    {
        ...
        alignment_formatter::apply_padding(pattern_buffer, padding_buffer, flag_end_pos - to_align_size, to_align_size,
                                           alignment_flag_info.width, alignment_flag_info.fill_char,
    ...
    void alignment_formatter<BufferLimits>::apply_padding(details::memory_buffer<BufferLimits::pattern>& pattern_buffer,
                                                          char* padding_buffer, std::size_t to_align_pos,
