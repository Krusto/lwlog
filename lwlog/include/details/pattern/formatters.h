...
namespace lwlog::details
{
	...
	struct level_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
			formatter<BufferLimits>::format_attribute(
	...
	template<typename BufferLimits>
	struct message_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct thread_id_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct process_id_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct line_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct path_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer,
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct file_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct function_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct topic_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
			formatter<BufferLimits>::format_attribute(
				pattern_buffer, conv_buffer,
				flag::topic,
				record.topics.topics()[record.topic_index]
			);
		}
	};

	template<typename BufferLimits>
	struct full_topic_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
			formatter<BufferLimits>::format_attribute(
				pattern_buffer, conv_buffer,
				flag::full_topic,
				record.topics.full_topic(record.topic_index)
			);
		}
	};

	template<typename BufferLimits>
	struct date_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct date_short_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct year_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct year_short_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct month_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct month_name_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct month_name_short_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct day_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct weekday_name_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct weekday_name_short_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct time_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct hour_clock_24_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct hour_clock_12_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct ampm_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct hour_24_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct hour_12_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct minute_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct second_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct millisecond_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct microsecond_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
	...
	template<typename BufferLimits>
	struct nanosecond_formatter : public formatter<BufferLimits>
	{
		void format(details::memory_buffer<BufferLimits::pattern>& pattern_buffer, char* conv_buffer, 
			const record<BufferLimits>& record) const override
		{
