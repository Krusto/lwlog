...
namespace lwlog::details
{
    ...
    struct bounded_queue {
        ...
        using overflow_adapter =
                overflow_adapter<bounded_queue<Capacity, T, OverflowPolicy, ConcurrencyModelPolicy>, OverflowPolicy>;
    ...
    private:
        template <typename... Args>
        void enqueue_slow([[maybe_unused]] spsc_model_policy, Args&&... args);
        template <typename... Args>
        void enqueue_slow([[maybe_unused]] mpsc_model_policy, Args&&... args);

        template <typename... Args>
        bool try_enqueue([[maybe_unused]] spsc_model_policy, Args&&... args);
        template <typename... Args>
        bool try_enqueue([[maybe_unused]] mpsc_model_policy, Args&&... args);
    ...
    private:
        ...
        alignas(cache_line_size) std::atomic_flag m_mpsc_lock{};
    };
}// namespace lwlog::details
