...
namespace lwlog::details
{
    ...
    struct record {
        ...
        record(const char* const message, level log_level, const source_meta& meta, const topic_registry& topics,
               std::uint8_t topic_index)
            : message{message}, log_level{log_level}, meta{meta}, topics{topics}, topic_index{topic_index}
        {}
