...
namespace lwlog::sinks
{
	...
	template<typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
	void file_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::sink_it(details::record<BufferLimits> record)
	{
	...
	template<typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
	void file_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::sink_it(std::string_view message)
	{
