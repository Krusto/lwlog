...
namespace lwlog::sinks
{
	...
	public:
		stderr_sink();
		void sink_it(details::record<BufferLimits> record) override;
	...
	template<typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
	void stderr_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::sink_it(details::record<BufferLimits> record)
	{
	...
	template<typename BufferLimits, typename FlushPolicy, typename ThreadingPolicy>
	void stderr_sink<BufferLimits, FlushPolicy, ThreadingPolicy>::sink_it(std::string_view message)
	{
